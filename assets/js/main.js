console.log("hi switch");
 ...
 function check(){
    let text=document.getElementById("bundeslandInfo").value 
      document.getElementById("bundeslandInfoErgebnis").style.display="block"
    ...
    switch (info) {
        ...
        default:
            ...
            document.getElementById("wrong").innerHTML="Ein solches Bundesland gibt es in Deutschland nicht."
            document.getElementById("bundeslandInfoErgebnis").style.display="none"
            break;
    }
}   
